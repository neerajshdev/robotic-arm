...
public class Robot_arm extends PApplet {
...
public void setup() {
  ...
  // keyPoll initialization
  keyPoll = new int[256];
  Arrays.fill(keyPoll, -1);
  printArray(keyPoll);
  ...
  connect.onClick(
    ...
    public void controlEvent(CallbackEvent ev) {
      if (connectionThread == null || !connectionThread.isAlive()) {
        connectionThread = new Thread(runConnection);
...
public void draw() {
  ...
  if (isOpen==true) {
    b1x = b1x+(250-b1x)*0.1f; 
    b1.setPosition(b1x, b1y);
    b2x = b2x+(750-b2x)*0.1f; 
    b2.setPosition(b2x, b2y);
  }


  if (isOpen==true && b2Open==true) {
    m1x = m1x+(500-m1x)*0.1f; 
    m1.setPosition(m1x, m1y);
    m2x = m2x+(610-m2x)*0.1f; 
    m2.setPosition(m2x, m2y);
    m3x = m3x+(500-m3x)*0.1f; 
    m3.setPosition(m3x, m3y);
    m4x = m4x+(610-m4x)*0.1f; 
    m4.setPosition(m4x, m4y);
    m5x = m5x+(500-m5x)*0.1f; 
    m5.setPosition(m5x, m5y);
    m6x = m6x+(610-m6x)*0.1f; 
    m6.setPosition(m6x, m6y);
    m7x = m7x+(500-m7x)*0.1f; 
    m7.setPosition(m7x, m7y);
    m8x = m8x+(610-m8x)*0.1f; 
    m8.setPosition(m8x, m8y);
    m9x = m9x+(500-m9x)*0.1f; 
    m9.setPosition(m9x, m9y);
    m10x = m10x+(610-m10x)*0.1f; 
    m10.setPosition(m10x, m10y);
  }


  if (!(isOpen==true && b2Open==true)) {
    m1x = m1x+(-100-m1x)*0.1f; 
    m1.setPosition(m1x, m1y);
    m2x = m2x+(1300-m2x)*0.1f; 
    m2.setPosition(m2x, m2y);
    m3x = m3x+(-100-m3x)*0.1f; 
    m3.setPosition(m3x, m3y);
    m4x = m4x+(1300-m4x)*0.1f; 
    m4.setPosition(m4x, m4y);
    m5x = m5x+(-100-m5x)*0.1f; 
    m5.setPosition(m5x, m5y);
    m6x = m6x+(1300-m6x)*0.1f; 
    m6.setPosition(m6x, m6y);
    m7x = m7x+(-100-m7x)*0.1f; 
    m7.setPosition(m7x, m7y);
    m8x = m8x+(1300-m8x)*0.1f; 
    m8.setPosition(m8x, m8y);
    m9x = m9x+(-100-m9x)*0.1f; 
    m9.setPosition(m9x, m9y);
    m10x = m10x+(1300-m10x)*0.1f; 
    m10.setPosition(m10x, m10y);
  }

  if (isOpen==true && b1Open==true) {
    k1x = k1x+(100-k1x)*0.1f; 
    k1.setPosition(k1x, k1y);
    k2x = k2x+(200-k2x)*0.1f; 
    k2.setPosition(k2x, k2y);
    k3x = k3x+(300-k3x)*0.1f; 
    k3.setPosition(k3x, k3y);
    k4x = k4x+(400-k4x)*0.1f; 
    k4.setPosition(k4x, k4y);
    k5x = k5x+(500-k5x)*0.1f; 
    k5.setPosition(k5x, k5y);
    k6x = k6x+(600-k6x)*0.1f; 
    k6.setPosition(k6x, k6y);
    k7x = k7x+(700-k7x)*0.1f; 
    k7.setPosition(k7x, k7y);
    k8x = k8x+(800-k8x)*0.1f; 
    k8.setPosition(k8x, k8y);
    k9x = k9x+(900-k9x)*0.1f; 
    k9.setPosition(k9x, k9y);
    k10x = k10x+(1000-k10x)*0.1f; 
    k10.setPosition(k10x, k10y);
    label1x = label1x+(100-label1x)*0.1f; 
    label1.setPosition(label1x, label1y);
    label4x = label4x+(140-label4x)*0.1f; 
    label4.setPosition(label4x, label4y);
    label5x = label5x+(340-label5x)*0.1f; 
    label5.setPosition(label5x, label5y);
    label6x = label6x+(550-label6x)*0.1f; 
    label6.setPosition(label6x, label6y);
    label7x = label7x+(730-label7x)*0.1f; 
    label7.setPosition(label7x, label7y);
    label8x = label8x+(960-label8x)*0.1f; 
    label8.setPosition(label8x, label8y);
  }
  if (!(isOpen==true && b1Open==true)) {
    k1x = k1x+(-200-k1x)*0.1f; 
    k1.setPosition(k1x, k1y);
    k2x = k2x+(1300-k2x)*0.1f; 
    k2.setPosition(k2x, k2y);
    k3x = k3x+(-100-k3x)*0.1f; 
    k3.setPosition(k3x, k3y);
    k4x = k4x+(1300-k4x)*0.1f; 
    k4.setPosition(k4x, k4y);
    k5x = k5x+(-100-k5x)*0.1f; 
    k5.setPosition(k5x, k5y);
    k6x = k6x+(1300-k6x)*0.1f; 
    k6.setPosition(k6x, k6y);
    k7x = k7x+(-100-k7x)*0.1f; 
    k7.setPosition(k7x, k7y);
    k8x = k8x+(1300-k8x)*0.1f; 
    k8.setPosition(k8x, k8y);
    k9x = k9x+(-100-k9x)*0.1f; 
    k9.setPosition(k9x, k9y);
    k10x = k10x+(1300-k10x)*0.1f; 
    k10.setPosition(k10x, k10y);
    label1x = label1x+(-600-label1x)*0.1f; 
    label1.setPosition(label1x, label1y);
    label4x = label4x+(-600-label4x)*0.1f; 
    label4.setPosition(label4x, label4y);
    label5x = label5x+(-600-label5x)*0.1f; 
    label5.setPosition(label5x, label5y);
    label6x = label6x+(1300-label6x)*0.1f; 
    label6.setPosition(label6x, label6y);
    label7x = label7x+(1300-label7x)*0.1f; 
    label7.setPosition(label7x, label7y);
    label8x = label8x+(1300-label8x)*0.1f; 
    label8.setPosition(label8x, label8y);
  }
  if (isOpen==true && b2Open==true) {
    label2x = label2x+(100-label2x)*0.1f; 
    label2.setPosition(label2x, label2y);
  }
  if (!(isOpen==true && b2Open==true)) {
    label2x = label2x+(-600-label2x)*0.1f; 
    label2.setPosition(label2x, label2y);
  } 
...
public void keyBoardPoll() {
  for (int k = 0; k < 256; k++) {
    if (keyState[k]) {
      keyPoll[k] = (keyPoll[k] == -1) ? 1 : keyPoll[k] + 1;
    } else if (keyPoll[k] != -1){
      keyPoll[k] = 0;
    }
  }
...
public void sendCommands() {
  if (keyPoll[KeyEvent.VK_W] == 1) {
    comPort.write("w"); 
  } else if (keyPoll[KeyEvent.VK_W] == 0) { 
    comPort.write("w"); 
    keyPoll[KeyEvent.VK_W] = -1;
  }
  if (keyPoll[KeyEvent.VK_S] == 1) {
    comPort.write("s");
    println("s is sent");
  } else if (keyPoll[KeyEvent.VK_S] == 0) { 
    println("s is sent again");
    comPort.write("s");  
    keyPoll[KeyEvent.VK_S] = -1;
  }
  if (keyPoll[KeyEvent.VK_A] == 1) {
    comPort.write("a");
  } else if (keyPoll[KeyEvent.VK_A] == 0) { 
    comPort.write("a");  
    keyPoll[KeyEvent.VK_A] = -1;
  }
  if (keyPoll[KeyEvent.VK_D] == 1) {
    comPort.write("d");
  } else if (keyPoll[KeyEvent.VK_D] == 0) { 
    comPort.write("d");  
    keyPoll[KeyEvent.VK_D] = -1;
  }
  if (keyPoll[KeyEvent.VK_Q] == 1) {
    comPort.write("q");
  } else if (keyPoll[KeyEvent.VK_Q] == 0) { 
    comPort.write("q");  
    keyPoll[KeyEvent.VK_Q] = -1;
  }
  if (keyPoll[KeyEvent.VK_E] == 1) {
    comPort.write("e");
  } else if (keyPoll[KeyEvent.VK_E] == 0) { 
    comPort.write("e");  
    keyPoll[KeyEvent.VK_E] = -1;
  }
  if (keyPoll[KeyEvent.VK_I] == 1) {
    comPort.write("i");
  } else if (keyPoll[KeyEvent.VK_I] == 0) { 
    comPort.write("i");  
    keyPoll[KeyEvent.VK_I] = -1;
  }
  if (keyPoll[KeyEvent.VK_K] == 1) {
    comPort.write("k");
  } else if (keyPoll[KeyEvent.VK_K] == 0) { 
    comPort.write("k");  
    keyPoll[KeyEvent.VK_K] = -1;
  }
  if (keyPoll[KeyEvent.VK_J] == 1) {
    comPort.write("j");
  } else if (keyPoll[KeyEvent.VK_J] == 0) { 
    comPort.write("j");  
    keyPoll[KeyEvent.VK_J] = -1;
  }
  if (keyPoll[KeyEvent.VK_L] == 1) {
    comPort.write("l");
  } else if (keyPoll[KeyEvent.VK_L] == 0) { 
    comPort.write("l");  
    keyPoll[KeyEvent.VK_L] = -1;
  }
}


public void mouseCheck() {
  if (b2Open == true && comPort != null) {
    if (m1.isPressed()) {
      comPort.write("q");
      println("Gripper+");
    }
...
public void tryConnection() {
  ...
  for (String port : Serial.list()) {
    try {
      comPort = new Serial(this, port, baudRate);
...
public void serialEvent(Serial p) { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Robot_arm" };
    if (passedArgs != null) {
